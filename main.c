...
/*   Updated: 2023/09/21 13:48:39 by ddyankov         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	render(t_game *game)
{
	...
	//ft_draw_player(game);
	ft_draw_circle(game);
	ft_draw_line(game, game->player.x, game->player.y, game->player.x + game->player.delta_x * 5, game->player.y + game->player.delta_y * 5);
